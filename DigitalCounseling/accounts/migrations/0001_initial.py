    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('marital_status', models.CharField(choices=[(1, 'single'), (2, 'married'), (3, 'divorced')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('answer', models.ManyToManyField(to='accounts.answer')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('middle_name', models.CharField(max_length=200)),
                ('last_name', models.CharField(max_length=200)),
                ('education_level', models.CharField(choices=[(1, 'BSC'), (2, 'Masters'), (3, 'Phd')], max_length=10)),
                ('dob', models.DateField()),
                ('marital_status', models.CharField(choices=[(1, 'single'), (2, 'married'), (3, 'divorced')], max_length=20)),
                ('emergency_contact', models.CharField(max_length=15)),
                ('pub_date', models.DateTimeField()),
